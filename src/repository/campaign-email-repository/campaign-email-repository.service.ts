...
import { CreateCampaignEmailDto, CreateCampaignResponseDto } from '@/modules/campaign-email/dto';
...
@Injectable()
export class CampaignEmailRepositoryService implements CampaignEmailRepositoryServiceAbstract {
	...
	// async createCampaign(data: CreateCampaignEmailDto): Promise<CampaignEmailEntity> {
	// 	return this.prisma.campaignEmail.create({ data });
	// }
